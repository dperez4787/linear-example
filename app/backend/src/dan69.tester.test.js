...
test('criterion 3: one exchange sends four calls whose bodies carry max_tokens 1500/1500/1200/500, matching the exported constant', async () => {
  ...
  // whatever the constant says. Literals updated by DAN-72 (trimmed budgets
  // so an opus round fits Hosting's 60s timeout).
  const expected = {
    'product-owner': 1500,
    architect: 1500,
    planner: 1200,
